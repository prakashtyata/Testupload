...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '22px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#878e8e'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '29px', 'lineheight' => '29px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#34312e'));
			...
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '22px', 'lineheight' => '24px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#faf9f9'));
								
			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '29px', 'lineheight' => '29px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#f8f3f0'));
								
			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '22px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#34312e'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '52px', 'lineheight' => '52px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
